 ...
 * PackageName cn.vpclub.spring.boot.shiro.autoconfigure.util
 * ModifyDate  16-10-19
 * Description (非法字符处理工具类)
...
public class XssShieldUtil {
    ...
    private static List<Object[]> getXssPatternList() {
        ...
        ret.add(new Object[]{"xss", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL});
        ret.add(new Object[]{"confirm", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL});
        ret.add(new Object[]{"prompt", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL});
